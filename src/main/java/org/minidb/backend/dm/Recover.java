...
public class Recover {
    ...
    private static void undoTranscations(TransactionManager tm, Logger lg, PageCache pc) {
        ...
        for(Entry<Long, List<byte[]>> entry : logCache.entrySet()) {
            ...
            tm.abortTransaction(entry.getKey());
        }
    }
    ...
    public static byte[] insertLog(long xid, Page pg, byte[] raw) {
        ...
        byte[] offsetRaw = Parser.short2Byte(PageOthers.getFreeSpaceOffset(pg));
        return ArrayUtil.concatArray(logTypeRaw, xidRaw, pgnoRaw, offsetRaw, raw);
    }
    ...
    private static void doInsertLog(PageCache pc, byte[] log, int flag) {
        ...
        try {
            ...
            PageOthers.recoverInsert(pg, li.raw, li.offset);
        } finally {
            pg.releasePage();
        }
    }
